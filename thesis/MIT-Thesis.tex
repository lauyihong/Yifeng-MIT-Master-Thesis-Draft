...
%\usepackage[backend=bibtex]{biblatex}  % Commented out - loaded later with more options
%\addbibresource{mitthesis-sample.bib}
...
\usepackage{multirow}% For multirow cells in tables (https://ctan.org/pkg/multirow)
...
\title{From Extraction to Retrieval: A Graph-Enhanced Framework for Spatio-Temporal Reasoning in Historical Legal Documents}
...
\Author{Yifeng Liu}{Department of Electrical Engineering and Computer Science}
...
\Degree{Master in City Planning}{Department of Urban Studies and Planning}  
...
\Supervisor{Sarah Williams}{Associate Professor of Technology and Urban Planning}
\Supervisor{Manish Raghavan}{Professor of MIT Sloan School of Management and EECS}
...
\include{chapter5}
\include{chapter6}
\include{chapter0} % template

%\include{chapter_note}  % Commented out - file path issue
